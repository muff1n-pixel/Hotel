...
CREATE TABLE `user_pets` (
  ...
  KEY `petId` (`petId`),
  KEY `userId` (`userId`),
  CONSTRAINT `user_pets_ibfk_133` FOREIGN KEY (`petId`) REFERENCES `pets` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `user_pets_ibfk_134` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
