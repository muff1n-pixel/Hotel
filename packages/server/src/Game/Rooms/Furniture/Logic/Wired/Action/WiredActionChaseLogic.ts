...
export default class WiredActionChaseLogic extends WiredActionLogic {
    ...
    public async handleAction(options?: WiredTriggerOptions): Promise<void> {
        ...
        for(const furnitureId of this.roomFurniture.model.data.common.furnitureSelection.furnitureIds) {
            ...
            const targetDirection = Directions.getDirectionFromPositions(RoomPositionOffsetData.fromJSON(roomFurniture.model.position), RoomPositionOffsetData.fromJSON(closestUser.position));
