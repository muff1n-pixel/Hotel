...
export type RoomChatMessageProps = {
    style: string;
...
export default function RoomChatMessage({ style, user, figureConfiguration, message }: RoomChatMessageProps) {
    ...
    useEffect(() => {
        (async () => {
            ...
            canvasRef.current.height = chatStyleImage.height;
            ...
            figureRenderer.renderToCanvas(FigureRenderer.figureWorker, 0, false).then((sprite) => {
                context.drawImage(
                    sprite.image,
