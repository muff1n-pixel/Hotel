...
import UserFurnitureNotificationEvent from "./Communications/User/Notifications/UserFurnitureNotificationEvent";
...
export default class ClientInstance extends EventTarget {
    ...
    constructor(public readonly element: HTMLElement) {
        ...
        webSocketClient.addProtobuffListener(UserFurnitureNotificationData, new UserFurnitureNotificationEvent());
