...
CREATE TABLE `user_friend_requests` (
  ...
  CONSTRAINT `user_friend_requests_ibfk_1` FOREIGN KEY (`senderId`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `user_friend_requests_ibfk_2` FOREIGN KEY (`receiverId`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
-- Dump completed on 2026-03-29 20:41:30
