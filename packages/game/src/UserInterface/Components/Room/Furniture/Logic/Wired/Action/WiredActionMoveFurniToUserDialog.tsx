...
export default function WiredActionMoveFurniToUserDialog({ data, onClose }: RoomFurnitureLogicDialogProps) {
    const room = useRoomInstance();

    const [furnitureIds, setFurnitureIds] = useState(data.data.data?.wiredActionMoveFurniToUser?.furnitureIds ?? []);
    ...
    const handleApply = useCallback(() => {
        ...
        onClose();
    }, [furnitureIds, delayInSeconds, data, onClose, room]);
