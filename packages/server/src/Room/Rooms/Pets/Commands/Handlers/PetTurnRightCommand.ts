...
export default class PetTurnRightCommand extends PetCommand {
    async handle(roomUser: RoomUser): Promise<void> {
        ...
        this.roomPet.direction = Directions.normalizeDirection(this.roomPet.direction + Directions.RIGHT);
